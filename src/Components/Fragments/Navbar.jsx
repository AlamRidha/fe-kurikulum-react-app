        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            <div className="flex items-center ms-3">
              ...
              <div
                className={`absolute right-0 top-12 mt-1 w-auto min-w-40 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600 ${
                  isDropDownOpenToogle ? "block" : "hidden"
                }`}
                id="dropdown-user"
              >
                {/* <div
